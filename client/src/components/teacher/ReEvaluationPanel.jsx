...
export const ReEvaluationPanel = () => {
  const [queries, setQueries] = useState([
    { id: 'q1', rollNo: '23345227188', name: 'SAHIL SUMRANI', subject: 'Python Programming', currentGrade: 'B+', requestedReview: 'Theory Re-checking requested', status: 'PENDING' },
    { id: 'q2', rollNo: '23345227189', name: 'SIMRAN KAPOOR', subject: 'Financial Accounting', currentGrade: 'A', requestedReview: 'Internal Assessment review', status: 'PENDING' }
  ]);
